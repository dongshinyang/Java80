...
-- 강사
DROP TABLE IF EXISTS TECHERS RESTRICT;
...
ALTER TABLE LECTURES
  ADD CONSTRAINT PK_LECTURES -- 교육과정 기본키
    PRIMARY KEY (
      LNO -- 교육과정번호
    );
...
-- 강사
ALTER TABLE TECHERS
  ADD CONSTRAINT PK_TECHERS -- 강사 기본키
    PRIMARY KEY (
      TNO -- 강사번호
    );

-- 강사 유니크 인덱스
CREATE UNIQUE INDEX UIX_TECHERS
  ON TECHERS ( -- 강사
    EMAIL ASC -- 강사이메일
  );

-- 강사 인덱스
CREATE INDEX IX_TECHERS
  ON TECHERS( -- 강사
    TNM ASC -- 강사명
  );
...
-- 수강신청
ALTER TABLE LEC_APPL
  ADD CONSTRAINT FK_LECTURES_TO_LEC_APPL -- 교육과정 -> 수강신청
    FOREIGN KEY (
      LNO -- 교육과정번호
    )
...
-- 수강신청
ALTER TABLE LEC_APPL
  ADD CONSTRAINT FK_MEMBERS_TO_LEC_APPL -- 회원 -> 수강신청
    FOREIGN KEY (
      MNO -- 회원번호
    )
...
-- 교육과정
ALTER TABLE LECTURES
  ADD CONSTRAINT FK_ROOMS_TO_LECTURES -- 강의장 -> 교육과정
    FOREIGN KEY (
      RNO -- 강의장코드
    )
...
-- 강사배치
ALTER TABLE TEA_ASSIGN
  ADD CONSTRAINT FK_LECTURES_TO_TEA_ASSIGN -- 교육과정 -> 강사배치
    FOREIGN KEY (
      LNO -- 교육과정번호
    )
    REFERENCES LECTURES ( -- 교육과정
...
-- 강사배치
ALTER TABLE TEA_ASSIGN
  ADD CONSTRAINT FK_TECHERS_TO_TEA_ASSIGN -- 강사 -> 강사배치
    FOREIGN KEY (
      TNO -- 강사번호
    )
    REFERENCES TECHERS ( -- 강사
      TNO -- 강사번호
    );

-- 회원
ALTER TABLE MEMBERS
  ADD CONSTRAINT FK_ADDRS_TO_MEMBERS -- 주소 -> 회원
    FOREIGN KEY (
      ANO -- 주소번호
    )
    REFERENCES ADDRS ( -- 주소
